...
After this, I exported the ConS as an STL file and used Ultimaker Cura to make a 3D print of the curves.  This STL file is generated by evaluating the noteboook (running the .nb file in Mathematica)
